...
{
    public class HUMAHASZDanceTop40 : CChart
    {
        public HUMAHASZDanceTop40()
        {
            _countryCode = "HU"; _country = "Hungary";
            _name = "MAHASZ Dance Top 40";
            //sChartPath = MvcApplication.CorePath + @"\Charts\" + sCountryCode + @"\" + sName;
        ...
        public override List<CSong> GetCurrentChart()
        {
            ...
            string url = "http://www.mahasz.hu/?menu=slagerlistak&menu2=dance_top_40";
            ...
            str.Find("alt=\"Dance Top 40 lista\""); str.Skip();
