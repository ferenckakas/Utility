...
namespace SpotifyWebAPI
{
    public class Artist : BaseModel
    {
        ...
        {
            string json = await HttpHelper.Get("https://api.spotify.com/v1/artists/" + artistId);
        ...
        {
            string json = await HttpHelper.Get("https://api.spotify.com/v1/artists/?ids=" + CreateCommaSeperatedList(artistIds));
            ...
            foreach (artist item in obj.artists)
        ...
        {
            return await Album.GetArtistAlbums(Id);
        }
        ...
        {
            return await GetTopTracks(Id, countryCode);
        }
        ...
        {
            string json = await HttpHelper.Get("https://api.spotify.com/v1/artists/" + artistId + "/related-artists");
            var obj = JsonConvert.DeserializeObject<artistarray>(json, new JsonSerializerSettings
            {
                TypeNameHandling = TypeNameHandling.All,
                TypeNameAssemblyFormatHandling = TypeNameAssemblyFormatHandling.Simple
