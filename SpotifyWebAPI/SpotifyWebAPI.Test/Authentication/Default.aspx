...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form id="form1" runat="server">
            ...
            <br />
            <br />
            <asp:TextBox ID="clientIdTextBox" runat="server" Width="300px" Text="c49b94a7bba9420a96a061f40558cebc" />
            <h4>Client Secret:</h4>
            Required. The client secret provided to you by Spotify when you register your application. 
            <br />
            <br />
            <asp:TextBox ID="clientSecretTextBox" runat="server" Width="300px" Text="7511439d3be1476a8a650362058cabd7" />
            <h4>Redirect Uri:</h4>
